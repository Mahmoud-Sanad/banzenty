            ...
            <div class="form-group">
                ...
                <div class="d-flex">
                    <input class="form-control col-md-6 {{ $errors->has('title') ? 'is-invalid' : '' }}"
                        type="text" name="title[en]" id="title" value="{{ old('title.en', $role->getTranslation('title', 'en')) }}"
                        placeholder="English" required>
                    <input class="form-control col-md-6 {{ $errors->has('title') ? 'is-invalid' : '' }}"
                        type="text" name="title[ar]" id="title" value="{{ old('title.ar', $role->getTranslation('title', 'ar')) }}"
