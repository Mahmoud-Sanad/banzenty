...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="" for="fleet">fleet</label>
                <input class="form-control {{ $errors->has('fleet') ? 'is-invalid' : '' }}" type="text" name="fleet" id="fleet" value="{{ old('fleet', 'none') }}" >
                @if($errors->has('fleet'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fleet') }}
                    </div>
            ...
            {{-- <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('plans') ? 'is-invalid' : '' }}" name="plans[]" id="plans" multiple>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.plans_helper') }}</span>
            </div> --}}
            <div class="form-group">
